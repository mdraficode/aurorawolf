...
window.CAMP = (() => {
  ...
  /* ---------- the hierarchy (data-driven, see docs/CAMPAIGN_DESIGN.md) ---------- */
  const LEGENDS = [
...
/* SPEEDRUN FIX v6.7 — the name prompt never showed on a FRESH save. p4 injects the
   ...
   the overlay now that the campaign exists. Proven on a fresh save: #nameRow visible, #plName2 focusable. */
try {
