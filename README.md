...
- **🌳 Solid world** — big tree trunks and boulders are really there: run into one and you stop (and slide along it); crash head-on at sprint speed and it bites off 4 HP with a thud, dust and a stumble. Walking pace never hurts — it just blocks
